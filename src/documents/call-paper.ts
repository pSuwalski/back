...
export async function generateCallPaper(id: string, union: Union, owner: Owner, company: Company, cashAddress: string, bankName: string, bankAccount: string, contactPhone: string, contactEmail: string, stampAuth: InputStampAuth, status: string): Promise<string> {
  ...
  <body>
    ...
    <div class="table-container">
      ...
      <tr>  
        ...
        ${generateRows(owner.fees, ((owner.payments ? owner.payments : []).filter((p) => p.type === 'additionalCosts') as AdditionalCosts[]))}
